function [Seq,Recursions]=MinimumFitnessWithNoFeasibility(Seq,Recursions,Data,AssemblyData,ObjectiveType,MiniFitnessIndex)
...
%             Pop.Objective=[];
            for Si=1:LenOfSeq
                Pop.Position=[Seq(end),TempAssemblyData(Si).Task];
                Pop.Objective=[];
...
%                 end
%             end
            [Seq,Recursions]=MinimumFitnessWithNoFeasibility(Seq,Recursions,Data,TempAssemblyData,ObjectiveType,MiniFitnessIndex);
        end
    end
end